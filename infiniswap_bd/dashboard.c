...
int write_to_file(void){
    ...
    info.high_ex_read_latency = info.high_read_latency[info.read_num * EXCEPTION_RATIO];
    info.low_ex_read_latency = info.low_read_latency[info.read_num * EXCEPTION_RATIO];
    info.high_ex_write_latency = info.high_write_latency[info.write_num * EXCEPTION_RATIO];
    info.low_ex_write_latency = info.low_write_latency[info.write_num * EXCEPTION_RATIO];
